...
ActiveRecord::Schema.define(version: 20170809071421) do
  ...
  create_table "portofolios", id: :serial, force: :cascade do |t|
    t.string "title"
    t.string "area"
    t.string "category"
    t.string "size"
  ...
  create_table "teams", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "team_type", default: "Head-Office"
